...
class App extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    console.log('now: ', this.props, this.state);
  ...
  getMoviesFromApi = () => {
    fetch(
      `${API_URL}discover/movie?api_key=${API_KEY_3}&language=en-US&sort_by=${this.state.sort_by}&include_adult=false&include_video=false&page=1`
    )
    .then(response => {
